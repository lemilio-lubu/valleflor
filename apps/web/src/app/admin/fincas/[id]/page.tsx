        ...
        {showAdd && (
          ...
          >
            <div>
              ...
              <input className="input-field font-mono text-xs" required value={userId} onChange={(e) => setUserId(e.target.value)} placeholder="uuid del usuario" />
            </div>
            <div>
        ...
        <table className="w-full text-sm">
          ...
          <tbody>
            {(!finca?.responsables || finca.responsables.length === 0) && (
              <tr><td colSpan={2} className="empty-state">Sin responsables asignados</td></tr>
            )}
